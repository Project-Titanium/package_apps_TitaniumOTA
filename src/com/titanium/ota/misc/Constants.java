...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "ro.titanium.build_date_utc";
...
/*    static final String OTA_URL = " ";
    static final String DOWNLOAD_WEBPAGE_URL = " ";*/
    static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "Titanium-Updates/";
}
